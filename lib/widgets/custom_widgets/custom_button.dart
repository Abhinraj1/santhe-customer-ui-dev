  ...
  class CustomButton extends StatelessWidget {
    ...
    const CustomButton({Key? key, required this.onTap, required this.buttonTitle,
      this.width, this.verticalPadding, this.horizontalPadding, this.isActive}) : super(key: key);
