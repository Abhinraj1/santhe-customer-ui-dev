...
class _ONDCOrderDetailsScreenState extends State<ONDCOrderDetailsScreen> {
 // final String message = "You have initiated return "
  ...
  Widget body( context, List<SingleOrderModel> orderDetails){
    ...
    bool hasTrackingData = orderDetails.first.quotes!.
    first.tracks?.first.url == null ? false : true;
    ...
    return
      ...
      children: [
        ...
        OrderDetailsTable(
            ...
            thirdDataTextStyle: hasTrackingData ? FontStyleManager().s12fw700Blue : null,
            thirdDataOnTap: (){
        ...
        ShipmentCard(
            ...
            [
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    ...
                    bool isCancelable = products[index].cancellable == null ? false :
                                        products[index].cancellable as bool ;

                    isCancelable ? BlocProvider.of<OrderDetailsCubit>(context).
                    showCancelButton()  :
         ...
         InvoiceTable(
         prices: orderDetails.first.quotes!.first.cartItemPrices as List<CartItemPrices>,
