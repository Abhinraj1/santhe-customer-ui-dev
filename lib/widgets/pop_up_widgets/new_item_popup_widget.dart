                                  ...
                                  : MaterialButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (!widget.edit &&
                                          ...
                                          animateAdd(MediaQuery.of(context)
                                                  .size
                                                  .width /
                                              100);
                                        }
                                          ...
                                          if (_formKey.currentState!
                                            ...
                                            if (imageController
                                              ...
                                              final listItem = ListItem(
                                                brandType: _brandController
                                                        .text.isEmpty
                                                    ? item.dBrandType.replaceAll(
                                              ...
                                              if (itemCount != 0) {
                                                Item newCustomItem = Item(
                                                    dBrandType: _brandController.text.isEmpty
                                                        ? item.dBrandType.replaceAll(
                                                                placeHolderIdentifier, '') +
                                                            placeHolderIdentifier
                                                        : _brandController.text,
                                                    dItemNotes: _notesController
                                                            .text.isEmpty
                                                        ? item.dItemNotes.replaceAll(
                                                                placeHolderIdentifier, '') +
                                                            placeHolderIdentifier
                ...
                child: AnimatedContainer(
                  ...
                  child: Obx(
                    ...
                    () => Stack(
                      children: [
                        CachedNetworkImage(
                          imageUrl: imageController.editItemCustomImageUrl.value
                                      .isNotEmpty &&
                                  imageController
