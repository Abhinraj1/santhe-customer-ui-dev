      ...
      children: [
        Align(
            ...
            child: Padding(
              ...
              child:
                  Text("Select Item", style: FontStyleManager().s16fw600Orange),
            )),
        InkWell(
          onTap: () {
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColors().grey60, width: 1),
                    ...
                    child: Align(
                      ...
                      child: Text(
                        selectedCartItemPriceId.value.isNotEmpty
                            ? "You Selected ${selectedCartItemPriceId.value.length} Products"
                            : " ",
