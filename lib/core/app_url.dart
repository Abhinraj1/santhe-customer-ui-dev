...
class AppUrl {
  ...
  static const String _baseUrlDev = 'https://ondcstaging.santhe.in';

  static const String _baseUrlProd = 'https://api.santhe.in';

  String get baseUrl => _dev ? _baseUrlDev : _baseUrlProd;
