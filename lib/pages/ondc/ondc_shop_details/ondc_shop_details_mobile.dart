...
class _OndcShopDetailsMobileState extends State<_OndcShopDetailsMobile>
  ...
  fetchNewSearchItems(
    ...
    final url = Uri.parse(
        '${AppUrl().baseUrl}/santhe/ondc/store/item/nearby?storeLocation_id=$shopId&search=$productName&limit=10&offset=$nsearch&firebase_id=$firebaseId');
    setState(() {
      _searchLoading = true;
    });
    try {
  ...
  fetchData(
    ...
    final Uri url = Uri.parse(
        '${AppUrl().baseUrl}/santhe/ondc/store/item/nearby?storeLocation_id=$shopId&search=&limit=10&offset=$n&firebase_id=$firebaseId');
    setState(() {
      _loading = true;
    });
    try {
